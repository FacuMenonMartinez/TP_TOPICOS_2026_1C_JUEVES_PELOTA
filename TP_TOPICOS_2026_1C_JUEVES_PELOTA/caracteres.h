...
#define FUENTE_SEGUNDA_ANCHO 6
#define FUENTE_SEGUNDA_ALTO 6
...
extern const uint8_t fuente_Segunda[CANTIDAD_CARACTERES][FUENTE_SEGUNDA_ALTO][FUENTE_SEGUNDA_ANCHO];
