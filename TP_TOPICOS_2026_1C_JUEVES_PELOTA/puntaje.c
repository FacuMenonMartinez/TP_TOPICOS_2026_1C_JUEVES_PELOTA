...
void mostrar_Puntaje (uint16_t puntos, uint8_t eje_X, uint8_t eje_Y){
    ...
    //Llamo a la funcion dibujar Caracter y le paso las coordenadas para que queden una al lado de la otra.
        dibujar_Caracter_F2(u_Mil, eje_X,eje_Y + FUENTE_PRIMERA_ALTO+3,2,12);
        dibujar_Caracter_F2(u_Cien, eje_X + (FUENTE_SEGUNDA_ANCHO+1)*2,eje_Y + FUENTE_PRIMERA_ALTO+3,2,12);
        dibujar_Caracter_F2(u_Dec, eje_X + (FUENTE_SEGUNDA_ANCHO+1)*4,eje_Y + FUENTE_PRIMERA_ALTO+3,2,12);
        dibujar_Caracter_F2(u_Uni, eje_X + (FUENTE_SEGUNDA_ANCHO+1)*6,eje_Y + FUENTE_PRIMERA_ALTO+3,2,12);
