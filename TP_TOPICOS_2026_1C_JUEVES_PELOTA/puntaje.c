...
void mostrar_Puntaje (int puntos, uint8_t eje_X, uint8_t eje_Y){
    ...
    //Llamo a la funcion dibujar Caracter y le paso las coordenadas para que queden una al lado de la otra.
        dibujar_Caracter_F1(u_Mil, eje_X,eje_Y,1,12,5,4);
        dibujar_Caracter_F1(u_Cien, eje_X + 12,eje_Y,1,12,5,4);
        dibujar_Caracter_F1(u_Dec, eje_X + 24,eje_Y,1,12,5,4);
        dibujar_Caracter_F1(u_Uni, eje_X + 36,eje_Y,1,12,5,4);
}
